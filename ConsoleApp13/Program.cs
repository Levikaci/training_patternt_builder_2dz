    ...
    public class ManualBuilder : IBuilder
    {
        ...
        public void SetSeats(int number) => _manual.Description += $"Имеет {number} сидений.";
        public void SetEngine(string engine) => _manual.Description += $"Двигатель: {engine}.";
        public void SetTripComputer() => _manual.Description += "Оснащен бортовым компьютером.";
        public void SetGPS() => _manual.Description += "Встроенный GPS.";
    ...
    public class Director
    {
        public void MakeSportsCar(IBuilder builder)
        {
            builder.Reset();
            builder.SetSeats(2);
            builder.SetEngine(" двигатель V8");
